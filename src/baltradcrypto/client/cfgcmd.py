...
class Command(object):
    ...
    def get_implementation_by_name(cls, name):
        ...
        the implementing class is looked up from 'baltradcrypto.config.commands'
        entry point. 
    ...
    def get_commands(cls):
        return pkg_resources.get_entry_map("baltradcrypto")["baltradcrypto.config.commands"].keys()
